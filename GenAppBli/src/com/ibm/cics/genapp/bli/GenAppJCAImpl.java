...
public class GenAppJCAImpl implements GenAppInterface {
	...
	public CustomerData[] listCustomers(int startCustomer, int maxCount)
		...
		if (debug) System.out.println("listCustomers("+startCustomer+","+maxCount+") found "+carray.length+" customers.");
	...
	public PolicyData[] listPolicies(int custNumber) throws GenAppException {
		...
		if (debug) System.out.println("listPolicies for customer "+custNumber+" found "+policyList.size()+" policies.");
